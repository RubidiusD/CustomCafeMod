...
import PatchEverything.util.TriFunction;
...
import static PatchEverything.util.GeneralUtils.removePrefix;
import static PatchEverything.util.TextureLoader.getCardTextureString;
...
public abstract class BaseCard extends CustomCard {
    public static class CardStats {
        ...
        public final CardRarity cardRarity;
        public final CardColor cardColor;

        public CardStats(CardColor cardColor, CardType cardType, CardRarity cardRarity, CardTarget cardTarget, int baseCost)
        {
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    EverythingPatchMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
