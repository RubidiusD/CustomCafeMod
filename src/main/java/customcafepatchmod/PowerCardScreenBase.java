...
public class PowerCardScreenBase {
    public static PowerCardScreen generateScreen(PowerelicRelic relic) {
    ...
    public static class PowerCardScreen implements ScrollBarListener {
        ...
        private final PowerelicRelic relic;

        public PowerCardScreen(PowerelicRelic target) {
